...
namespace MenAtWork\WfExtendedBreadcrumbBundle\Module;

use Contao\BackendTemplate;
use Contao\Module;

class ExtendedBreadcrumb extends Module
{
    /**
     * Template
     *
    ...
    protected function compile(): void
    {
        ...
        for ($i = (count($arrPages) - 1); $i > 0; $i--) {
            ...
            if (($arrPages[$i]['hide'] && !$this->wf_extendedBreadcrumb_hidden) || $arrPages[$i]['MenAtWork\WfExtendedBreadcrumbBundle\Module\wf_extendedBreadcrumb'] || (!$arrPages[$i]['published'] && !BE_USER_LOGGED_IN)) {
                continue;
            }
